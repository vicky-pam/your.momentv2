...
<html lang="en">
  ...
  <body class="background-color" style="background-color: #232830;">
    <!-- <nav start -->
            ...
            <ul class="navbar-nav  me-auto mb-2 mb-lg-0 ">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu active" style="background-color: rgb(139, 120, 13);">
                  ...
                  <li><a class="dropdown-item active" href="/your.moment/web/tour/toba/">Danau Toba</a></li>
                </ul>
              </li>
              <li class="nav-item">
  ...
  <h1 class="text-light center"> COMING SOON</h1>
